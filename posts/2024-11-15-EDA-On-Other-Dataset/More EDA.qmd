...
The combination of the data is shown below, and done using the code in "/scripts/load_and_clean_data.R". Below is a table, which displays each new column and its description. Followed by the new combined data itself.
