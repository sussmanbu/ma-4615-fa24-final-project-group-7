...
download.file("https://sussmanbu.github.io/ma-4615-fa24-final-project-group-7/dataset_for_shiny/region_shapefile.zip", temp)
shapefile <- sf::st_read(unzip(temp, exdir = tempdir()))
