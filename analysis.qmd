...
The model achieved an R-squared value of 0.008, indicating that while the model explains a small portion of the variability in improper police behavior, the predictors are statistically significant contributors.
